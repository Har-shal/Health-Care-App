...
private Connection connect(){
    ...
    private void initComponents() {
        ...
        jLabel3.setText("App. Date");

        jLabel4.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel4.setText("App. Time");

        jLabel5.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel5.setText("Eld. ID");
        ...
        jLabel8.setText("FILL IT FOR APPROPRIATE ACTION");

        jLabel7.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel7.setText("Inv. ID");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String Query = "SELECT * FROM appoinments ";
          try {
            ...
            rs.next();
            String sql = "insert into appoinments values (?, ?, ?, ?, ?, ?)";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            String sql =  "update appoinments set app_date=?, app_time=?, doc_id=?, eld_id=?, inv_id=? WHERE app_id=?";
            PreparedStatement pstmt = conn.prepareStatement(sql);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            String sql = "DELETE FROM appoinments WHERE app_id=?" ;
            PreparedStatement pstmt = conn.prepareStatement(sql);
              pstmt.setString(1, jTextField1.getText());
